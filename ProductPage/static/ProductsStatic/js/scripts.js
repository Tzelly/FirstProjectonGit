...
!(function(e) {
      ...
      t || (t = 700),
        ...
        V.click(function() {
          return (
            e('body,html')
              .stop(!0)
              .animate({ scrollTop: 0 }, Number(t), a),
            !1
          );
        });
    },
          ...
          SEMICOLON.isMobile.Android() &&
            e('#primary-menu ul li.sub-menu')
              ...
              .on('touchstart', function(t) {
                e(this)
                  .parent('li.sub-menu')
                  .hasClass('sfHover') || t.preventDefault();
              }),
                  ...
                  SEMICOLON.slider.sliderParallaxDimensions(),
                    ...
                    e('.swiper-slide-active [data-caption-animate]').each(
                      function() {
                        var t,
                          a = e(this),
                          i = a.attr('data-caption-delay');
                        if (
                          ((t = i ? Number(i) + 750 : 750),
                          !a.hasClass('animated'))
                        ) {
      ...
      sliderParallaxOffset: function() {
        ...
        return (
          (a.hasClass('side-header') || s.hasClass('transparent-header')) &&
            (t = 0),
          (e = z.length > 0 ? z.outerHeight() + t : t),
    ...
    (SEMICOLON.portfolio = {
      ...
      ajaxload: function() {
        e('.portfolio-ajax .portfolio-item a.center-icon').click(function(t) {
          ...
          e(this)
            .parents('.portfolio-item')
            .hasClass('portfolio-active') || SEMICOLON.portfolio.loadItem(a, A),
            t.preventDefault();
        });
      },
        ...
        if (0 == i) {
          ...
          F.load(o, { portid: t, portnext: s, portprev: n }, function() {
            SEMICOLON.portfolio.initializeAjax(t),
              ...
              P.removeClass('portfolio-active'),
      ...
      animations: function() {
        ...
        t.length > 0 &&
          ...
          t.each(function() {
            var t,
              a = e(this),
              i = a.attr('data-animate-out'),
              s = a.attr('data-delay'),
              n = a.attr('data-delay-out'),
              o = 3e3;
            if (a.parents('.fslider.no-thumbs-animate').length > 0) return !0;
            if (
              ((t = s ? Number(s) + 500 : 500),
              i && n && (o = Number(n) + t),
              !a.hasClass('animated'))
            ) {
              a.addClass('not-animated');
      ...
      html5Video: function() {
        ...
        t.length > 0 &&
          t.each(function() {
            ...
            } else (l = (o - s) / 2), a.css({ width: n + 'px', height: o + 'px', top: -l + 'px' });
          ...
          t.length > 0 &&
            t.each(function() {
              var t,
                ...
                n = s.length;
              (a =
                i.hasClass('tabs-bordered') || i.hasClass('tabs-bb')
                  ? i.find('.tab-nav').outerWidth()
                  : i.find('tab-nav').hasClass('tab-nav2')
                    ? i.find('.tab-nav').outerWidth() - 10 * n
                    : i.find('.tab-nav').outerWidth() - 30),
                (t = Math.floor(a / n)),
                s.css({ width: t + 'px' });
            });
        }
        ...
        1 == t
          ? e.find('span').countTo({
              formatter: function(e, t) {
                return (e = e.toFixed(t.decimals)).replace(
                  /\B(?=(\d{3})+(?!\d))/g,
                  ','
                );
              }
          ...
          return (
            ...
            e('html,body')
              ...
              .animate(
                ...
                function() {
                  o &&
                    (e(a).find('.highlight-me').length > 0
                      ? (e(a)
                          .find('.highlight-me')
  ...
  var t = e(window),
    ...
    T = '',
    z = e('#page-title'),
    P = e('.portfolio-ajax').find('.portfolio-item'),
